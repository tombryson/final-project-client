  ...
  const Seat = ({ col, row, onSeatClick }) => {
    ...
    return (
      <button
        ...
        onClick={() =>
          _handleOnSeatClick(
            { col, row, user_id, flight_id, name },
            onSeatClick,
          )
        }
    ...
    <>
      ...
      <div className="seat-map-container">
        ...
        >
          ...
          <path
            d="M125,100 Q140,40 155,110 Q140,120 125,110 Z"
            fill="grey"
          ></path>
          <polygon
            points="90,60 30,100 30,120 90,100"
            fill="darkgrey"
          ></polygon>
          <polygon
            points="110,60 170,100 170,120 110,100"
            fill="darkgrey"
          ></polygon>
          <line
            x1="90"
                ...
                <tr className="seat-info">
                  <td>
                    ...
                    {isClicked ? (
                      ...
                      <i style={{ fontSize: '1rem' }}>Unselected</i>
                    )}
                  </td>
                </tr>
                <tr className="flight-info">
                  <td colSpan="2">${flight.price}</td>
                </tr>
                <tr>
                  {isClicked ? (
                    <tr>
                      <button
                        ...
                        onClick={() => _handleOnConfirmClick(seat)}
                      >
                        Select Seat&#x2705;
                      </button>
                    </tr>
