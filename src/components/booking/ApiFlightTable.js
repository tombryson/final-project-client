                ...
                <tr className="table-data-container extra-info-row open">
                  <td colSpan={6}>
                    <img
                      ...
                      height="50"
                      style={{
                        backgroundColor: getBackgroundImage(
                          flight.carrier.iata,
                        ),
                      }}
                    />
                  ...
                  <th>Flight</th>
                  <td style={{ width: '56px' }}>{flight.flightNumber}</td>
                  ...
                  <div className="flight-time-groupings">
                    <tr style={{ whiteSpace: 'nowrap' }}>
                      <th className="flight-times">
                        {convertTo12HourFormat(flight.departure.time.local)}
                      </th>
                      <td>&#x2192;</td>
                      <th className="flight-times">
                        {convertTo12HourFormat(flight.arrival.time.local)}
                      </th>
                    </tr>
                    <tr>
                      <td className="date-of-flight">
                        {format(
                          parseISO(flight.departure.date.local),
                          'do MMMM',
                        )}
                      </td>
                      <td></td>
                  ...
                  <th className="flight-prices">
                    <span style={{ color: 'white', fontSize: 'small' }}>
                      from
                    </span>{' '}
                    {` $${flight.price}`}
                  </th>
                  <td style={{ padding: '1.6rem 0.4rem 1.6rem 1.4rem' }}>
                    <button
                  ...
                  >
                    <button
                      ...
                      onClick={() => _openInfo(flight.flightNumber)}
                    >
                    ...
                    <td className="extra-flight-svg">
                      ...
                      >
                        <path
                          fill="currentColor"
                          fill-rule="evenodd"
                          d="M20.126 6.259h-4.875V4.586a.83.83 0 0 0-.813-.836H9.563a.83.83 0 0 0-.814.836V6.26H3.874A1.654 1.654 0 0 0 2.25 7.93v10.875a1.654 1.654 0 0 0 1.624 1.673h16.252a1.654 1.654 0 0 0 1.624-1.669V7.935a1.654 1.654 0 0 0-1.624-1.672zM9.968 5.213a.416.416 0 0 1 .408-.42h3.248c.228.004.41.191.409.42v1.046H9.968zM7.125 18.81H5.5V7.935h1.624zm11.374 0h-1.624V7.935H18.5z"
                          clip-rule="evenodd"
                        ></path>
                      </svg>
                    </td>
                    ...
                    <td className="extra-flight-svg">
                      ...
                      >
                        <path
                          fill="currentColor"
                          fill-rule="evenodd"
                          d="M4 9a3 3 0 0 0 3 3v9a1 1 0 1 0 2 0v-9a3 3 0 0 0 3-3V3a1 1 0 1 0-2 0v6H9V3a1 1 0 0 0-2 0v6H6V3a1 1 0 0 0-2 0zm11-4v6a3 3 0 0 0 3 3v7a1 1 0 1 0 2 0V4a2 2 0 0 0-2-2 3 3 0 0 0-3 3"
                          clip-rule="evenodd"
                        ></path>
                      </svg>
                    </td>
                    <td>Meals on request</td>
                    <td className="extra-flight-svg">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
