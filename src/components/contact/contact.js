  ...
  return (
    ...
    <div className="contact-container">
      <div className="contact-button-container">
        <h1>Get in touch</h1>
        <button style={{backgroundColor: "transparent", border: "none"}} onClick={() => _onClick("email")}>
        ...
        <button style={{backgroundColor: "transparent", border: "none"}}onClick={() => _onClick("github")}>
        ...
        <button style={{backgroundColor: "transparent", border: "none"}} onClick={() => _onClick("linkedIn")}>
